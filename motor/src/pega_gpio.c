...
#define CHECK_GPIO(gpio, name)                                 	\
    do {                                                       	\
        gpio = devm_gpiod_get(&pdev->dev, name, GPIOD_OUT_LOW); \
        if (IS_ERR(gpio)) {                                    	\
...
{
	CHECK_GPIO(IO_O_nFAULT_PAN, "IO_I_MOTOR_nFAULT_PAN");
	CHECK_GPIO(IO_O_nFAULT_RISING, "IO_I_MOTOR_nFAULT_RISING");
	CHECK_GPIO(IO_O_RISING_MOTOR_nSLEEP, "IO_O_RISING_MOTOR_nSLEEP");
	CHECK_GPIO(IO_O_PAN_MOTOR_nSLEEP, "IO_O_PAN_MOTOR_nSLEEP");
	CHECK_GPIO(IO_O_MOTO_PWM0, "IO_O_MOTO_PWM0");
	CHECK_GPIO(IO_O_MOTO_PWM1, "IO_O_MOTO_PWM1");
	CHECK_GPIO(IO_O_MOTO_PWM2, "IO_O_MOTO_PWM2");
	CHECK_GPIO(IO_O_MOTO_PWM3, "IO_O_MOTO_PWM3");
