...
//==============================================================================
int Pega_nxp_wifi_country_code_get(int bIsWiFi1)
{
	uint8_t *buffer = NULL;
	...
	if (bIsWiFi1 > 0)
	{
		strncpy(ifr.ifr_ifrn.ifrn_name, "mlan0", strlen("mlan0"));
	}
	else
	{
		strncpy(ifr.ifr_ifrn.ifrn_name, "mlan1", strlen("mlan1"));
	}	
...
//==============================================================================
int Pega_nxp_wifi_country_code_set(int bIsWiFi1, uint8_t *countryCode)
{
	uint8_t *buffer = NULL;
	struct eth_priv_cmd *cmd = NULL;	
	struct ifreq ifr;
