...
void rfalNfcWorker( void )
{
    ...
    {   
        ...
        case RFAL_NFC_STATE_START_DISCOVERY:
            ...
            //printf("state: RFAL_NFC_STATE_START_DISCOVERY\n");
            ...
            {
                printf("Initialize WAKEUP MODE config.\n");
        ...
        case RFAL_NFC_STATE_WAKEUP_MODE:
            //printf("state: RFAL_NFC_STATE_WAKEUP_MODE\n");
            ...
            if( rfalWakeUpModeHasWoke() )
            {
                ...
                //printf("state: Stop Wake up mode\n");
        ...
        case RFAL_NFC_STATE_POLL_TECHDETECT:
            //printf("state: RFAL_NFC_STATE_POLL_TECHDETECT\n");
        ...
        case RFAL_NFC_STATE_POLL_COLAVOIDANCE:
            //printf("state : RFAL_NFC_STATE_POLL_COLAVOIDANCE\n");
        ...
        case RFAL_NFC_STATE_POLL_ACTIVATION:
            //printf("state: RFAL_NFC_STATE_POLL_ACTIVATION\n");
        ...
        case RFAL_NFC_STATE_DATAEXCHANGE:
            //printf("state: RFAL_NFC_STATE_DATAEXCHANGE\n");
        ...
        case RFAL_NFC_STATE_DEACTIVATION:
            //printf("state: RFAL_NFC_STATE_DEACTIVATION\n");
        ...
        case RFAL_NFC_STATE_LISTEN_TECHDETECT:
            //printf("state: RFAL_NFC_STATE_LISTEN_TECHDETECT\n");   
