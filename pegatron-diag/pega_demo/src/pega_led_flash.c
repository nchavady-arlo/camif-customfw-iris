...
{			 
	 ...
	 prctl(PR_SET_NAME, "LedFlash"); //set the thread name
...
{	
	...
	switch(ePattern)
	{
		...
		case LED_PATTERN_FLASHING_GREEN_FAST:
		     m_stLED.u16Period            = 100;
			 m_stLED.eLedFlashing_Color   = LED_FLASH_COLOR_G;			 
		     break;
...
/*00*/{  LED_State_None,				 	0},
/*01*/{  LED_State_Voice_Cmd_training,		1},
/*02*/{  LED_State_Voice_Cmd_standby,		10},
/*03*/{  LED_State_Voice_Cmd_recognized,	10},
/*04*/{  LED_State_Voice_Cmd_wait,		    10},
};
...
int Pega_led_flash_state_Set(uint16_t estate)
{
	...
	switch(m_eLED_State)
	{
		case LED_State_None:
		     ...
		     break;
		case LED_State_Voice_Cmd_training:	//Fast blinking green
		     ePattern = LED_PATTERN_FLASHING_GREEN_FAST;
		     break;
		case LED_State_Voice_Cmd_standby:	//Solid green
		     ePattern = LED_PATTERN_COLOR_GREEN;
		     break;
		case LED_State_Voice_Cmd_recognized: //Led off
		     ePattern = LED_PATTERN_NONE;
		     break;	 
		case LED_State_Voice_Cmd_wait:		//Slow blinking green
		     ePattern = LED_PATTERN_FLASHING_GREEN;
		     break;
        //==============================================================================		
        default:
             break;
