...
int main() {
    ...
    uint8_t tx_buffer[TRANSFER_SIZE] = {
        0x02, 0x30, 0x00, 0x03, 0x00, 0x81, 0x02, 0x01,                                 
    ...
    printf("Send data: 0x02 0x30 0x00 0x03 0x00 0x81 0x02 0x01 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00\n");
    ...
    printf("Expected Received data: 0x02 0xFB 0x01 0x05 0x00 0x81 0x06 0x01 0x04 0x03\n");
    printf("Real Received data: ");
