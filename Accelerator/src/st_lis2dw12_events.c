...
//add new iio_event_type
#define IIO_EV_TYPE_GESTURE	6
		
//add new  iio_event_direction
#define IIO_EV_DIR_SINGLETAP 4
#define IIO_EV_DIR_DOUBLETAP 5

//add iio_event_info
#define IIO_EV_INFO_RESET_TIMEOUT    6
#define IIO_EV_INFO_TAP2_MIN_DELAY   7
...
int st_lis2dw12_event_handler(struct st_lis2dw12_hw *hw)
{
	...
	if ((reg_src[2] & ST_LIS2DW12_D6D_SRC_D6D_IA_MASK) &&
		...
		dev_info(&iio_dev->dev, "Pushed IIO event with id=0x%llx\n", event);
		printk("End\n");
	}
