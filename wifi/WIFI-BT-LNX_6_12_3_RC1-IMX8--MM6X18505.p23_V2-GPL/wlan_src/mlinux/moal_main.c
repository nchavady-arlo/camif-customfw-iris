...
mlan_status woal_request_fw(moal_handle *handle)
{
	...
	PRINTM(MMSG, "Request firmware: %s(LinuxVer:%d)\n", handle->drv_mode.fw_name, LINUX_VERSION_CODE);
...
#else 
#if LINUX_VERSION_CODE > KERNEL_VERSION(2, 6, 32)//true
