...
void wls_unpack_csi(unsigned int *bufferMemory, unsigned int *outBuffer,
		    hal_wls_packet_params_t *packetparams,
		    hal_wls_processing_input_params_t *inputVals,
		    unsigned int *totalpower);
int wls_calculate_toa(unsigned int *headerBuffer, unsigned int *fftInBuffer,
		      unsigned int *fftBuffer, unsigned int *totalpower,
		      hal_wls_packet_params_t *packetparams,
		      hal_wls_processing_input_params_t *inputVals);

void wls_intialize_reference(unsigned int *headerBuffer,
			     unsigned int *fftInBuffer, float *fftRefBuffer);
